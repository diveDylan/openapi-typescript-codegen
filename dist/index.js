...
function getMappedType$1(type) {
    return TYPE_MAPPINGS$1.get(type.toLowerCase());
}
...
var fetchSendRequest = {"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    return "async function sendRequest(options: ApiRequestOptions, url: string): Promise<any> {\n    const request = {\n        headers: await getHeaders(options),\n        data: getRequestBody(options), // umi\n    };\n    return await _request[options.method](url, request);\n}";
},"useData":true};
...
var templateExportModel = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = lookupProperty(helpers,"equals").call(depth0 != null ? depth0 : (container.nullContext || {}),lookupProperty(depth0,"export"),"enum",{"name":"equals","hash":{},"fn":container.program(7, data, 0),"inverse":container.program(9, data, 0),"data":data,"loc":{"start":{"line":12,"column":0},"end":{"line":16,"column":0}}})) != null ? stack1 : "");
  ...
  return ((stack1 = container.invokePartial(lookupProperty(partials,"header"),depth0,{"name":"header","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    ...
    + "\n"
    + ((stack1 = lookupProperty(helpers,"equals").call(alias1,lookupProperty(depth0,"export"),"interface",{"name":"equals","hash":{},"fn":container.program(4, data, 0),"inverse":container.program(6, data, 0),"data":data,"loc":{"start":{"line":10,"column":0},"end":{"line":16,"column":11}}})) != null ? stack1 : "");
},"usePartial":true,"useData":true};
...
var templateExportSchema = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),lookupProperty(depth0,"extends"),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":5,"column":0},"end":{"line":7,"column":9}}})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data) {
    var stack1, alias1=container.lambda;
  ...
  return ((stack1 = container.invokePartial(lookupProperty(partials,"header"),depth0,{"name":"header","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "\n"
    + ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),lookupProperty(depth0,"extends"),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":3,"column":0},"end":{"line":8,"column":7}}})) != null ? stack1 : "")
    + "\nexport const $"
...
var templateExportService = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = container.invokePartial(lookupProperty(partials,"header"),depth0,{"name":"header","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    ...
    + ((stack1 = alias3(alias2(depth0, "alias", {"start":{"line":8,"column":40},"end":{"line":8,"column":45}} ), depth0)) != null ? stack1 : "")
    + "';\n"
    ...
    + "\nexport class "
    + ((stack1 = alias3(alias2(depth0, "name", {"start":{"line":13,"column":16},"end":{"line":13,"column":20}} ), depth0)) != null ? stack1 : "")
    + " {\n\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,lookupProperty(depth0,"operations"),{"name":"each","hash":{},"fn":container.program(6, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":15,"column":4},"end":{"line":78,"column":13}}})) != null ? stack1 : "")
    + "}";
},"usePartial":true,"useData":true};
...
async function writeClientCore(client, templates, outputPath, httpClient) {
    ...
    await writeFile(path.resolve(outputPath, 'ApiResult.ts'), templates.core.apiResult({}));
    await writeFile(path.resolve(outputPath, 'umi-request.ts'), templates.core.umiRequest({}));
 ...
 */
async function writeClientIndex(client, templates, outputPath, useUnionTypes, exportCore, exportServices, exportModels, exportSchemas, alias) {
 ...
 */
async function writeClientServices(services, templates, outputPath, httpClient, useUnionTypes, useOptions, alias) {
 ...
 * @param exportSchemas: Generate schemas
 */
async function writeClient(client, templates, output, httpClient, useOptions, useUnionTypes, exportCore, exportServices, exportModels, exportSchemas, alias) {
 ...
 */
async function generate({ input, output, httpClient = exports.HttpClient.FETCH, useOptions = false, useUnionTypes = false, exportCore = true, exportServices = true, exportModels = true, exportSchemas = false, write = true, apiAlias = '../core/request', }) {
